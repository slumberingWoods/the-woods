...
public class Player extends Actor
{
    ...
    public Player(int sanity, int light){
        this.sanity = sanity;
        this.light = light;
        sprites[0] = new GreenfootImage("Images/Player/Down0.png");
        sprites[1] = new GreenfootImage("Images/Player/Down1.png");
        sprites[2] = new GreenfootImage("Images/Player/Down2.png");
        sprites[3] = new GreenfootImage("Images/Player/Up0.png");
        sprites[4] = new GreenfootImage("Images/Player/Up1.png");
        sprites[5] = new GreenfootImage("Images/Player/Up2.png");
        sprites[6] = new GreenfootImage("Images/Player/Right0.png");
        sprites[7] = new GreenfootImage("Images/Player/Right1.png");
        sprites[8] = new GreenfootImage("Images/Player/Right2.png");
        sprites[9] = new GreenfootImage("Images/Player/Left0.png");
        sprites[10] = new GreenfootImage("Images/Player/Left1.png");
        sprites[11] = new GreenfootImage("Images/Player/Left2.png");
